---
title: "Match day 24 Season 2526"
...
#set away
Match_Away <- paste0("Newcastle")

#Set Home
Match_Home <- paste0("Liverpool")

#set match date
Game_date <- paste("31-01-2026")
...
### column {.tabset}
```{r}
#| title: Home 1st Half Pass Recieving Areas
#| label: Home 1st Half Pass Recieving Areas
...
```
```{r}
#| title: Home 2nd Half Pass Recieving Areas
#| label: Home 2nd Half Pass Recieving Areas
...
```
```{r}
#| title: Home Up to 1st Sub Pass Recieving Areas
#| label: Home Up to 1st Sub Pass Recieving Areas
...
### column {.tabset}
```{r}
#| title: Away 1st Half Pass Recieving Areas
#| label: Away 1st Half Pass Recieving Areas
...
```
```{r}
#| title: Away 2nd Half Pass Recieving Areas
#| label: Away 2nd Half Pass Recieving Areas
...
```
```{r}
#| title: Away Up to 1st Sub Pass Recieving Areas
#| label: Away Up to 1st Sub Pass Recieving Areas
